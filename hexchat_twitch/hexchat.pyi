...
Contains no functionality. Only Signatures. Full Documentation:
...
CallbackAttrs: Type[Callable] = Callable[
    [List[str], List[str], Userdata, Attribute], HookHandler
]
...
def hook_print(
    name: str, callback: Callback, userdata: Userdata = None, priority=PRI_NORM
) -> HookHandler: ...
def hook_print_attrs(
    name: str, callback: CallbackAttrs, userdata: Userdata = None, priority=PRI_NORM
) -> HookHandler: ...
def hook_server(
    name: str, callback: Callback, userdata: Userdata = None, priority=PRI_NORM
) -> HookHandler: ...
...
def hook_timer(
    timer: float, callback: Callback, userdata: Userdata = None
) -> HookHandler: ...
def hook_unload(callback: Callback, userdata: Userdata = None) -> HookHandler: ...
